(()=>{
  ...
  window.submitAppointment=async function(event){
    ...
    const duration=Number(values.get('duration_minutes')||slot?.duration_minutes||30);button.disabled=true;button.textContent=t('Enviando…','Sending…');errorEl.textContent='';
