...
(() => {
  ...
  css.textContent=`
    .mx-action-icon{width:24px;height:24px;display:inline-grid;place-items:center;flex:0 0 24px}
    ...
    .card-main-action.wa .mx-action-icon{background:#fff;border-radius:50%;padding:2px}
    .card-main-action.wa .mx-action-icon svg{width:20px;height:20px}
  `;
