...
(() => {
  ...
  function applyPublicTheme(){if(typeof isPublicRoute!=='function'||!isPublicRoute())return;document.body.classList.add('mx-public-card');applyThemeToRenderedCard(state?.card)}
