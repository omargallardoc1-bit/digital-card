...
(() => {
  ...
  const css=document.createElement('style');css.textContent=`
    ...
    .screen .action,.public-card .action{background:var(--mx-button,#16A34A)!important;border-color:var(--mx-button,#16A34A)!important;color:var(--mx-button-text,#FFFFFF)!important}
