...
(() => {
  ...
  const css=document.createElement('style');css.textContent=`
    ...
    .screen .action,.public-card .action,.screen .card-main-action:not(.wa),.public-card .card-main-action:not(.wa),.screen .card-secondary-action,.public-card .card-secondary-action{background:var(--mx-button,#16A34A)!important;border-color:var(--mx-button,#16A34A)!important;color:var(--mx-button-text,#FFFFFF)!important}
    .screen .card-main-action.wa,.public-card .card-main-action.wa{background:#25D366!important;border-color:#25D366!important;color:#FFFFFF!important}
    .screen .card-main-action.wa:hover,.screen .card-main-action.wa:focus-visible,.public-card .card-main-action.wa:hover,.public-card .card-main-action.wa:focus-visible{background:#128C7E!important;border-color:#128C7E!important;color:#FFFFFF!important}
  ...
  function applyThemeToRenderedCard(card){if(!card)return;const t=themeFor(card);document.querySelectorAll('.screen,.public-card .card-profile').forEach(el=>{el.style.setProperty('--mx-card-bg',t.bg);el.style.setProperty('--mx-button',t.btn);el.style.setProperty('--mx-button-text',t.text);el.style.background=t.bg});document.querySelectorAll('.screen .action,.public-card .action,.screen .card-main-action:not(.wa),.public-card .card-main-action:not(.wa),.screen .card-secondary-action,.public-card .card-secondary-action').forEach(el=>{el.style.setProperty('background',t.btn,'important');el.style.setProperty('border-color',t.btn,'important');el.style.setProperty('color',t.text,'important')});document.querySelectorAll('.screen .card-main-action.wa,.public-card .card-main-action.wa').forEach(el=>{el.style.setProperty('background','#25D366','important');el.style.setProperty('border-color','#25D366','important');el.style.setProperty('color','#FFFFFF','important')});const row=document.querySelector('.public-language-row');if(row)row.style.background=t.bg}
