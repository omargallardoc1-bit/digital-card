...
(() => {
  ...
  const themeFor=card=>{const t=card?.theme||{},p=PRESETS[t.color_preset]||PRESETS.classic_mx;const btn=validHex(t.button_color)?t.button_color:p.btn;return{preset:t.color_preset||'classic_mx',bg:validHex(t.background_color)?t.background_color:p.bg,btn,text:validHex(t.button_text_color)?t.button_text_color:autoText(btn)}};
  ...
  function applyVisualMarkup(markup,card){const h=normalizeHeight(card?.banner_height),t=themeFor(card);let html=String(markup).replace('class="hero card-cover" style="',`class="hero card-cover" data-banner-height="${h}" style="min-height:${h}px;height:${h}px;`);html=html.replace('class="screen"',`class="screen" style="--mx-card-bg:${t.bg};--mx-button:${t.btn};--mx-button-text:${t.text};background:${t.bg}"`);html=html.replace('class="card-profile"',`class="card-profile" style="--mx-card-bg:${t.bg};--mx-button:${t.btn};--mx-button-text:${t.text};background:${t.bg}"`);return html}
